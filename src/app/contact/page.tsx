...
const Contact: React.FC = () => {
  ...
  return (
    <div className="min-h-[100vh]">
      <h1 className="my-12 text-center text-4xl font-bold max-lg:mt-12 max-lg:mb-0">
        Contact Us
      </h1>
      <div className="flex justify-around max-w-[1200px] mx-auto max-lg:flex-col">
        <div className="flex flex-col items-center w-1/2 max-lg:w-full max-lg:p-6">
          ...
          <p className="text-lg">
            ...
            to contact us and we will be happy to assist you. Thank you for
            visiting Platinum Threads!
          </p>
          <Image
            width={500}
            height={750}
        ...
        <div className="flex w-1/2 justify-center items-center max-lg:w-full">
          <form
            ref={form}
            onSubmit={sendEmail}
            className="flex flex-col my-0 mx-auto w-3/4">
            ...
            <div className="flex flex-col mt-5">
              <label htmlFor="info">Please provide feedback below:</label>
              <textarea
                name="info"
                id="info"
                className="bg-white border-[2px] border-black border-solid"
                cols={30}
                rows={10}></textarea>
            </div>
            <button
              type="submit"
              className="flex items-center justify-around p-3 bg-black w-40 my-6 mx-auto text-white cursor-pointer text-base max-lg:w-36">
